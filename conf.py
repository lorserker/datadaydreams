...
BLOG_AUTHOR = "Lorand Dali"  # (translatable)
BLOG_TITLE = "Data Daydreams"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
#SITE_URL = "http://www.datadaydreams.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.datadaydreams.com/"
BLOG_EMAIL = "lorand@lorand.me"
BLOG_DESCRIPTION = "demo bla demo site description"  # (translatable)
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
            ...
            ('https://about.me/lorand', 'About me', 'icon-user'),
            ('https://twitter.com/lorserker', 'My Twitter', 'icon-twitter'),
            ('https://github.com/lorserker', 'My Github', 'icon-github'),
        )
    }
